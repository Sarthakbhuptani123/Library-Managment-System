...
?>
	<div class="container" >
		...
		<div class="content">
			<?php
				$query_retriveuser="SELECT *from librarian WHERE lId='$_GET[lId]'";
    ...
    <h1>Librarian Detail Form</h1><br>
	    <form action="editlibrariancode.php" method="POST">
	        <label for="title"> Librarian id:</label>
          <td><input type="textbox" name="lId1" value="<?php echo $lId;?>"  ></td>
		      <label for="title">Librarian name:</label>
          <td><input type="textbox" name="LName1" value="<?php echo $LName;?>" ></td>
		      <label for="author">contact no:</label>
          <td><input type="textbox" name="contactNo1" value="<?php echo $contactNo;?>" ></td>
          ...
          <label for="pages">password:</label>
          <td><input type="password" name="password1" value="<?php echo $password;?>"  ></td>
