	...
	<section id="content">
		...
		<main>
			<div class="head-title">
				...
				<a href="book1.php" class="btn-download">
					...
					<table>
						...
						<?php
							...
							<tr>
								...
								<td><a class="logg"  href="../admin panel/editbook.php?bId=<?php echo $bId;?>">
										<i class='bx bxs-log-out-circle' ></i>
										<span class="text">Edit</span>
										</a></td>
								<td><a class="logg"  href="../admin panel/deletebook.php?bId=<?php echo $bId;?>">
										<i class='bx bxs-log-out-circle' ></i>
