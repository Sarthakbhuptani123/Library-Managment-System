...
?>
	<div class="container" >
		...
		<div class="content">
			<?php
				$query_retriveuser="SELECT *from student WHERE sId='$_GET[sId]'";
    ...
    <h1>Student Detail Form</h1><br>
	    <form action="editstudentcode.php" method="POST">
	        <label for="title"> Student id:</label>
          <td><input type="textbox" name="sId1" value="<?php echo $sId;?>"  ></td>
		      <label for="title">student name:</label>
          <td><input type="textbox" name="sName1" value="<?php echo $sName;?>" ></td>
